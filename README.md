...
univariate and bi variate analysis was conducted and a better understanding of the data was found
...
various feature selection techniques where used for feature selectionm, and each of these methods where used to build a model to find the best one
...
and thus it was selected for the final pipelin.
...
for regressor model we chose linear regressor, lasso regressor (L1 norm)


and we found out the best model was linear regressor and thus it was selected for the pipeline.
...
- Both models weretrained on historical data from the platform, considering a range of financial factors and borrower information.
